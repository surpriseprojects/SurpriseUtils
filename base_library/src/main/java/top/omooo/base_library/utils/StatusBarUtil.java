package top.omooo.base_library.utils;
 ...
 * README
 * 该类只暴露了三个公有方法：
 * @see #init(Activity) 只需要放在基类里面初始化
 * @see #setStatusBarBlackMode(Activity) 设置状态栏图标和字体为黑色（默认）
 * @see #setStatusBarWhiteMode(Activity) 设置状态栏图标和字体为白色
 */
